...
| Recruit 3 allies | 4 | Shared data-driven villagers now support authored Home anchors and Ambient → RecruitReady dialogue after Wolf completion. Actual Recruit → Follow behavior, multiple followers, persistence, and party feedback remain; recruitment state must eventually be authoritative/synchronized. |
